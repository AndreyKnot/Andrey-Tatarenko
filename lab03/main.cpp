/**
 * @mainpage
 * <b> Лабораторна робота № 3. <br/> ПОТОКИ  </b>
 * <br/><b><i>Мета роботи:</i></b>: отримати знання про основи роботи з потоковим введенням / виведенням на мові С++,  роботу з файлами та рядками типу string. <br/>
